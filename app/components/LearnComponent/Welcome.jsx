...
const Welcome = () => {
    ...
    return (
        <>
            ...
            <div className='grid lg:grid-cols-4  md:grid-cols-2 grid-cols-1  md:gap-6 gap-7 place-items-center place-content-center max-w-screen-2xl  px-2 mx-auto mt-14 text-center'>
